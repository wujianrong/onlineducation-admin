...
<style scoped>
.management_first{padding:5px 0 0 15px}
.management_second{display:inline-block;line-height:40px;font-size:16px;text-align:right}
.el-dialog__header{border-bottom:1px solid #e9e9e9}
.form_input_g{width:430px}
.mentable{height:272px;overflow-y:scroll}
.management_first_class{padding:15px 5px;border:1px solid #e3e3e3;font-size:14px;position:relative}
.management_first_class:nth-child(n+4):before{content:'';height:1.1rem;width:1px;background-color:#dedede;position:absolute;top:-1.1rem;left:23px}
.management_first_class:hover{background-color:#f7f7f7}
.management_first_class:hover>span{color:#3C98FF}
.management_first_class>.el-icon-erp-icon-ic_ondemand_video{margin-left:.5rem;vertical-align:middle}
.management_first_class_children{float:right;margin-right:1rem;line-height:20px}
.management_first_class_children>i{font-size:14px}
.management_first_class_children>i:before{margin-right:.3rem}
</style>